...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.8\hsize]{fig/before_TS2/cut_example.pdf}
\caption{%
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\hsize]{fig/before_TS2/el_alignment_method.pdf}
\caption{%
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=\hsize]{fig/before_TS2/el_alignment.pdf}
\caption{%
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\hsize]{fig/before_TS2/hor_cuts.pdf}
\caption{%
Example of cleaning cuts, employing the correlation between the horizontal track positions in the near and far RP of each unit. Data from a sub-sample of the pre-TS2 period.
}
\label{fig:hor_cuts}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\hsize]{fig/before_TS2/hor_cuts_effect_cmp.pdf}
\caption{%
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\hsize]{fig/before_TS2/match_method_example.pdf}
\caption{%
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=\hsize]{fig/before_TS2/match_result_cmp_mean.pdf}
\caption{%
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\hsize]{fig/before_TS2/xi_cmp_run.pdf}
\caption{%
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\hsize]{fig/before_TS2/xi_cmp_rp.pdf}
\caption{%

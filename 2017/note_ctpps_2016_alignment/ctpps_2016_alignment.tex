...
\> describe idea
\>> unexpected tilt, discuss origins, suggest possible study

\> describe method, no matter what origin
\>> Figure~\ref{fig:vert_align_method}
...
\> result summary
\>> Figure~\ref{fig:vert_align_results}
\>> flat within 150um
\>> systematic effects, some correlated with unstable tilt, further investigations needed
...
\> comment on uncertainty: here or already above ?

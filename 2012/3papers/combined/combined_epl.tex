...
%
TOTEM also exploited two complementary ways of determining the total cross-section, both using the CMS luminosity measurement as an input and thus having very different systematic dependences. All results are in excellent agreement, making a first estimate for the $\rho$ parameter at $\sqrt{s} = 7\,$TeV possible: $|\rho| = 0.145 \pm 0.091$.
}

...
\PHnumber{2012-353}
\PHdate{29 November 2012}

\EXPnumber{TOTEM 2012-004}
...
M.~V\'itek\Iref{1b},
J.~Welti\IIref{3a}{3b}
J.~Whitmore\Iref{10} and
P.~Wyszkowski\IAref{8}{g}
\end{Authlist}
...
\Anotfoot{g}{AGH University of Science and Technology, Cracow, Poland, EU}
...
\begin{figure}
\begin{center}
\includegraphics{fig/sigma_el_to_sigma_tot_cern.pdf}
%\vskip-5mm
...
The ratio $\sigma_{\rm el}/\sigma_{\rm tot}$ can give some insights into the shape and the opacity of the proton, subject to model-dependent theoretical interpretations. The steady rise of this ratio with energy (Figure~\ref{fig:sigma rat} compiled from \cite{pdg}) is often interpreted as the increase of proton size and opacity with energy. 

...
\PHnumber{2012-239}
\PHdate{17 August 2012}

\EXPnumber{TOTEM 2012-002}
\EXPdate{14 August 2012}

\title{Measurement of proton-proton elastic scattering and total cross-section at $\sqrt s$ = 7\,TeV}
\ShortTitle{Measurement of $\rm pp$ elastic scattering and total cross-section at $\sqrt s = 7\,\rm TeV$}
...
\Instline{1a}{Institute of Physics of the Academy of Sciences of the Czech Republic, Praha, Czech Republic, EU}
\Instline{1b}{Czech Technical University, Praha, Czech Republic, EU}
\Instline{2} {National Institute of Chemical Physics and Biophysics NICPB, Tallinn, Estonia, EU}
\Instline{3a}{Helsinki Institute of Physics, Finland, EU}
\Instline{3b}{Department of Physics, University of Helsinki, Finland, EU}
\Instline{4} {MTA Wigner Research Center, RMKI, Budapest, Hungary, EU}
\Instline{5a}{INFN Sezione di Bari, Italy, EU}
\Instline{5b}{Dipartimento Interateneo di Fisica di Bari, Italy, EU}
\Instline{6a}{Sezione INFN, Genova, Italy, EU}
\Instline{6b}{Universit\`{a} degli Studi di Genova, Italy, EU}
\Instline{7a}{INFN Sezione di Pisa, Italy, EU}
\Instline{7b}{Universit\`{a} degli Studi di Siena and Gruppo Collegato INFN di Siena, Italy, EU}
...
\Anotfoot{a}{INRNE-BAS, Institute for Nuclear Research and Nuclear Energy, Bulgarian Academy of Sciences, Sofia, Bulgaria, EU}
\Anotfoot{b}{Ioffe Physical - Technical Institute of Russian Academy of Sciences, St.~Petersburg, Russian Federation}
\Anotfoot{c}{Warsaw University of Technology, Poland, EU}
\Anotfoot{d}{Institute of Nuclear Physics, Polish Academy of Science, Cracow, Poland, EU}
\Anotfoot{e}{Department of Atomic Physics, E\"otv\"os University, Hungary, EU}
...
1 & $6.5\,\sigma_{\rm beam}$ & 841k      & $68.0$                  & $7.3\cdot10^{-3}$ \cr
2 & $5.5\,\sigma_{\rm beam}$ & 106k      & $8.2$                   & $5.7\cdot10^{-3}$ \cr
3 & $4.8\,\sigma_{\rm beam}$ & 89k       & $6.6$                   & $4.6\cdot10^{-3}$ \cr\hline\hline
\end{tabular}
\end{center}
\end{table}
...
7 & $x^{*\rm R} - x^{*\rm L}$					& $9\un{\mu m}$ 	\cr\hline\hline
\end{tabular}
\end{center}
\end{table}
...
\begin{figure}
\begin{center}
\includegraphics{fig/B_s_cern.pdf}
\vskip-3mm
...
\begin{figure*}
\begin{center}
\includegraphics{fig/dsdt_comp_cern.pdf}
\vskip-3mm
...
\begin{tabular}{c@{\hskip10pt}clcc@{\hskip\ColSep}c@{\hskip\ColSep}c@{\hskip\ColSep}c@{\hskip\ColSep}l}\hline\hline
...
$\sigma_{\rm inel}$			& $\unt{mb}$ & $73.15$ & & $\pm 0.77$ & $\pm 0.29$ & $\pm 0.96$ & $\pm 0.10$ & $ \Rightarrow \pm 1.26$\cr\hline\hline
\end{tabular}
\end{center}
\end{table*}
}
...
\begin{tabular}{c@{\hskip15pt}cc}\hline\hline
...
$0.020\un{GeV^2}$ & $19.93 \pm 0.05^{\rm stat} \pm 0.21^{\rm syst}$ & $19.87 \pm 0.03^{\rm stat} \pm 0.33^{\rm syst}$\cr\hline\hline
\end{tabular}
\end{center}
\end{table*}
}

...
In order to reduce errors due to imperfect optics knowledge, the optics matching technique \cite{totem-optics} has been applied. The residual uncertainty has the form of factors scaling the scattering angles \textbf{[?????]}. % double-arm; before matching $0.48\un{\%}$ (hor), $0.90\un{\%}$

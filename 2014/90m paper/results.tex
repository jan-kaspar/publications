...
The fits have been performed by the standard least sqaures method, in particular minimising:
\begin{equation}
\label{eq:chi sq}
...
\end{pmatrix}\ ,
\end{equation}
where $\mat V_p$ is the uncertainty matrix for the difference vector $\Delta_p$. It yields $\chi_p^2 = 65.4$ which with $2$ degrees of freedom corresponds to a p-value of $6.2\cdot10^{-15}$ and a significance of $7.8\un{\sigma}$. This, in turn, rules out the hypothesis of a purely exponential behaviour of the data.

...
As shown in Table~\ref{tab:fit exp3}, both fits have reasonable fit quality and remarkably consistent values of $\rho$ (identical within the resolution) which are compared to previous determinations at lower energies in Fig.~\ref{fig:rho cmp exp3}. Let us repeat that the parameters of the nuclear amplitude ($a$ and $b_i$) are consistent between step 1 ($\beta^*=1000\un{m}$ data only) and step 2 (both $\beta^* = 1000$ and $ 90\un{m}$ data) of the fitting procedure.

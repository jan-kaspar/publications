...
\TODO{Consider alternative: replace everywhere $p_0$ with ${\pi\over 2} - \arctan{\rho}$}
...
\TODO{This equation seems unused -- remove?}
\begin{equation}
\label{eq:nuc slope}
...
The fits have proven to have extremely low sensitivity to a number of choices listed below.
\begin{itemize}
...
\item Extension of the nuclear modulus to non-measured $|t|$ region. \TODO{details}
...
\TODO{Make symbols consistent, find good place:}
\begin{equation}
\label{eq:si tot}

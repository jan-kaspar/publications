...
\label{eq:nuc phase per val}
	...
	\nu = 8.161\un{GeV^{-2}}\ .
\end{equation}
have been fixed to values maintaining the desired impact-parameter behaviour at $\sqrt s = 8\un{TeV}$ \cite{pk16}. This parametrisation with one free parameter will be denoted as {\bf peripheral phase} in what follows.

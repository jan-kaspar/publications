...
Simplified West-Yennie (SWY) formula~\cite{} is based on restrictive assumptions on the 
...
latter~\cite{} excludes a purely exponential hadronic elastic scattering
...
formula is applied in the present study, which offers much more freedom for the
...
expressed in
terms of $\rho$, become conditional to the choice of amplitude models.

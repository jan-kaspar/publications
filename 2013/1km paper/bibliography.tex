...
\bibitem{kmr15-slope}
	\Name{A.~D.~Martin, V.~A.~Khoze, M.~G.~Ryskin}
	\REVIEW{J.~Phys.}{G42}{2015}{2, 025003}
	%doi = http://dx.doi.org/10.1088/0954-3899/42/2/025003

\bibitem{fagundes11}
	\Name{D. A. Fagundes, E. G. S. Luna, M. J. Menon, A. A. Natale}
	LISHEP 2011, Worshop on LHC -- Present and Future, Rio de Janeiro, RJ, July 05-10, 2011, Brazil

\bibitem{block12}
	% Forward hadronic scattering at 8 TeV: Predictions for the LHC
	\Name{Martin M. Block and Francis Halzen}
	\REVIEW{Phys.~Rev.~D}{86}{2012}{014006}

\bibitem{kmr12-opacity}
	%Proton opacity in the light of LHC diffractive data
	\Name{Ryskin, M.~G., Martin, A.~D.~and Khoze, V.~A.}

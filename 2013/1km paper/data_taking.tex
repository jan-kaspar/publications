...
The vertical RPs approached the beam to only $3\,\sigma_{y}$ from the centre, resulting in an acceptance for protons with $|t|$-values down to $6 \times 10^{-4}\,\rm GeV^{2}$.



required low beam currents: two colliding bunch pairs and in each beam one 

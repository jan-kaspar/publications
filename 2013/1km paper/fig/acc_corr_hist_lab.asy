...
draw(Label("cut: $\theta_x^* > -50\un{\mu rad}$", 0, S, Fill(bp)), (0.06, 0.15)--(0.045, 0.3), EndArrow);
draw(Label("cut: $\theta_x^* < 80\un{\mu rad}$", 0, S, Fill(bp)), (0.16, 0.25)--(0.11, 0.43), EndArrow);
draw(Label("cut: $|\theta_y^*| < 100\un{\mu rad}$", 0, N, Fill(bp)), (0.11, 0.9)--(0.155, 0.65), EndArrow);

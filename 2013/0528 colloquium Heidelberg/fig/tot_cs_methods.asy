...
\kern2mm
\hbox{\cRe$\displaystyle\si_{\rm tot} = (98.6 \pm 2.3)\un{mb}$\cBlack}
}", v, d);
draw(v--zv, EndArrow);
...
\kern2mm
\hbox{\cRe$\displaystyle \si_{\rm tot} = (99.1 \pm 4.4)\un{mb}$\cBlack}
}", v, S+0.2W);
draw(v--zv, EndArrow);
...
\kern2mm
\hbox{\cRe$\displaystyle \si_{\rm tot} = (98.1 \pm 2.4)\un{mb}$\cBlack}
}", v, S+0.2E);
draw(v--zv, EndArrow);
...
\hbox{$\displaystyle \si_{\rm tot} = {16\pi\over 1+\cBlack\rh^2\cBlack}\ {\cBlack \d N_{\rm el}/ \d t|_{0}\cBlack \over\cBlack N_{\rm el}\cBlack + \cBlack N_{\rm inel}\cBlack}$}
\kern2mm
\hbox{\cRe$\displaystyle \si_{\rm tot} = (101.7 \pm 2.9)\un{mb}$\cBlack}
}", v, S+0.2E);
draw(v--zv, EndArrow);

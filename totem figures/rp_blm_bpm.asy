...
DrawRP("XRPH.D6R5.B1", 212.551, -2.0);
DrawRP("XRPV.D6R5.B1", 213.000, -1.0);
DrawBPM("BPMWT.D6R5.B1", 213.225);
DrawBLM("BLMEI.B6R5", "BLMEI.06R5.B1E10_XRP.D6R5.B1", 214.314, -1.0);

DrawBPM("BPMWT.A6R5.B1", 214.403);
DrawRP("XRPV.A6R5.B1", 214.628, -0.1);
DrawRP("XRPH.A6R5.B1", 215.077, +0.7);

DrawRP("XRPH.E6R5.B1", 215.710, +1.8);
DrawBLM("BLMEI.C6R5", "BLMEI.06R5.B1E10_XRP.E6R5.B1", 216.675, +2);

DrawRP("XRPH.B6R5.B1", 219.551, +0.4);
DrawRP("XRPV.B6R5.B1", 220.000, +1.5);

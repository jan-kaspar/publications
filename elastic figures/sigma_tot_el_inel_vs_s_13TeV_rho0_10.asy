...
fsh = +0fshu; DrawPoint(13e3, 110.58, 3.0, p_tot, m_TOTEM+p_tot);
fsh = +0fshu; DrawPoint(13e3,  79.54, 2.0, p_inel, m_TOTEM+p_inel);
fsh = +0fshu; DrawPoint(13e3,  31.04, 1.5, p_el+1pt, m_TOTEM+p_el);

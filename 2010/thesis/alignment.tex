...
\htab{al el yx}{The results of the elastic alignment method 1 -- vertical fits of y vs.~x data. The slope $a$ in $\rm mrad$, the intercept $b$ in $\rm\mu m$. The errors are statistical only.}{
...
\htab{al el y shift}{The results of the elastic alignment method 2 -- shift matching the $y$ distributions from the top and bottom pot. All values in $\rm \mu m$. The ucertainty can be estimated as a half of the bin size. Bin size $30\un{\mu m}$.}{
...
\Tb{al el dyy} summarizes the results (left part) and provides a comparison to method 2a (right part) -- the $\De y$ results from \Tb{al el y full} were used to predict the intercepts. With the exception of the sector 56 measurement from 5 October data, all the differences lie below the estimated error.

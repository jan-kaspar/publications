...
\fig{fig/pdf/CollimationAlignmentExample.pdf}{collimation alignment example}{An example of collimation alignment data (from 29 November 2009). The top and bottom pot movements(up) induced the BLM signals (bottom).}
...
So far, the collimation alignment has been repeated three times: 29 November 2009, 25 June 2010 (both at $450\un{GeV}$) and ?? at $7\un{TeV}$. The results suggest two unfortunate conclusions: RP LVDTs seemed wrongly calibrated and BPMs were unreliable.

BPM unreliable.

LVDT mis-calibration
...
\subsection{Input selection with real data}

...
\tab{al datasets}{List of data takings}{
...
\fig{fig/pdf/al_comp_rp_all_rot.pdf}{al comp rp all rot}{RP alignment comparison with fixed-detectors constraints. Circles: all tracks, squares: overlap tracks only. Showing only the far unit in 56-220, in the near one, the $\rh_z$ fluctuations are smaller.
\TODO{Shift comparision is misleading because of different geometries!}
}
...
\> Table of all rotations (big average) for all pots?

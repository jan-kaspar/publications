...
The derivation of Cahn \bref{cahn82} is clearly just the first order in $\al$, the fine structure constant. Therefore, one would naively expect the error to be of the order $1/\al\approx 1\percent$. However, looking closer one would find a rather benevolent manipulation with terms like
...
\fig{fig/pdf/el_cic_noff_F_C.pdf}{el cic noff FC}{bla}

\fig{fig/pdf/el_cic_noff_Psi.pdf}{el cic noff Psi}{bla}

\fig{fig/pdf/el_cic_noff_Z.pdf}{el cic noff Z}{bla}
...
\fig{fig/pdf/el_cic_diff_F_C.pdf}{el cic diff FC}{bla}

\fig{fig/pdf/el_cic_diff_F_C_darg.pdf}{el cic diff FC darg}{bla}

\fig{fig/pdf/el_cic_diff_Psi.pdf}{el cic diff Psi}{bla}

\fig{fig/pdf/el_cic_diff_Z.pdf}{el cic diff Z}{bla}

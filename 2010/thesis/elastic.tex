...
The underlying quantum-field-theory model suggests that core-core scattering (amplitude $F_{\rm H}$) it is mediated by the $\rm\om$ meson, acting as an elementary particle (see e.g.~\bref{islam06}):
...
\formula{complete-eikonal (CE) calculation:}

...
draw((0, -ht)--(0, ht), EndArrow); label("$x$", (0, ht), N);
...
x = 2; y = 3; draw((shx+x-b/2, shy)--(shx+x-b/2, shy+y)--(shx+x+b/2, shy+y)--(shx+x+b/2, shy), blue);
draw(((shx+x-b/2, shy+y)--(shx, shy+y)), dotted + blue); label("$4$", (shx, shy+y), W);
x = -3; y = 3/4; draw((shx+x-b/2, shy)--(shx+x-b/2, shy+y)--(shx+x+b/2, shy+y)--(shx+x+b/2, shy), red);
draw(((shx+x+b/2, shy+y)--(shx, shy+y)), dotted + red); label("$1$", (shx, shy+y), E);
x = -1; y = 3/4; draw((shx+x-b/2, shy)--(shx+x-b/2, shy+y)--(shx+x+b/2, shy+y)--(shx+x+b/2, shy), red);

label("background", (shx-2, shy+1), N, red);
label("track", (shx+2, shy+3.25), N, blue);
label("$\th$", (shx+2, shy), S);

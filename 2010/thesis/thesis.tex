...
In Geneva, 16 April, 2012 (3rd corrected version)
...
\ListAbb{BFKL}{Balitsky-Fadin-Kuraev-Lipatov}{Resummation of gluon ladders leading to a ``hard pomeron'', see e.g.~Ch.~8 in \bref{barone}.}
...
\ListAbb{DAQ}{Data AcQuisition}{A system to collect data from detectors and save them in a computer storage.}
...
\ListAbb{RECO}{RECOnstructed}{A format of data consisting of coordinate specifications of every reconstructed hit cluster.}
\ListAbb{RMS}{Root Mean Square}{}
\ListAbb{RP}{Roman Pot}{A pot-shaped movable beam-pipe insertion with detectors. A system of Roman Pots is one sub-detector of the TOTEM experiment, see \Sc{ttm det}.}

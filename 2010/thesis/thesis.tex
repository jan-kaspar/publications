...
\DefAbb{HP}{Hard Pomeron}{A version of the model of Islam et al., see Sc.~\sref{el models}.}
\DefAbb{IR}{InfraRed}{}
...
\DefAbb{RP}{Roman Pot}{A a pot-shaped movable beam-pipe insertion, see Sc.~\sref{ttm det}.}

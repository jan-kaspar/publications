...
{
\iitskip4pt
\line{\fig*[4cm]{fig/pdf/el_cic_diff_Z_slides.pdf}\hss\raise8mm\vbox{\hsize10.5cm
...
\line{\fig*[4cm]{fig/pdf/el_mod_Z_slides.pdf}\hss\raise30mm\vtop{\hsize10.5cm
\> comparison between hadronic models -- interference important in 
\>> ``Coulomb region'' ($|t|\approx 10^{-3}\un{GeV^2}$)
...
\centerline{\bf detector apparatus}
\vskip1mm
...
\line{\hss\fig[7cm]{fig/pdf/sr_sw_structure_slides_eg.pdf}\hskip5mm\raise6.8cm\vtop{\hsize8cm
...
\line{\hss\fig[7cm]{fig/pdf/sr_sw_structure_slides_bs.pdf}\hskip5mm\raise6.8cm\vtop{\hsize8cm
...
\line{\hss\fig[7cm]{fig/pdf/sr_sw_structure_slides_fs.pdf}\hskip5mm\raise6.8cm\vtop{\hsize8cm
...
\line{\hss\fig[7cm]{fig/pdf/sr_sw_structure_slides_pr.pdf}\hskip5mm\raise6.8cm\vtop{\hsize8cm
...
\line{\hss\fig[7cm]{fig/pdf/sr_sw_structure_slides.pdf}\hskip5mm\raise6.8cm\vtop{\hsize8cm
...
\>> RP position depends beam conditions
...
\fig*[3.cm]{fig/pdf/al_rp_scheme.pdf}}
...
\fig*[3.cm]{fig/pdf/detector_overlap.pdf}}
...
\centerline{\bf sensor misalignments}
\vskip1mm

\line{\hss\raise1cm\vbox{\hsize7cm
\> generally 3 shift and 3 rotations
$$\Downarrow$$
\> only 2 misalignments relevant
\>> shift in read-out direction $\De s$
\>> rotation about beam axis $\De\rh$

}\hskip3mm\fig*[,3.5cm]{fig/pdf/al_sensor_misalignments.pdf}\hss}

\vfil

\centerline{\bf track based alignment method}
\vskip1mm

\line{\hss\fig*[,3.5cm]{fig/pdf/al_proton_sensor_interaction_slides.pdf}\hskip3mm\vbox{\hsize7.3cm
...
\line{\hss\fig*[8cm]{fig/pdf/al_comp_det_per_unit.pdf}\hskip3mm\raise1mm\vbox{\hsize7.0cm
...
\> remove data affected by acceptance effects
...
\> background = everything that passes selection cuts but is not elastic

\bls

\line{\hss\vbox{%
	\fig*[4.5cm]{fig/pdf/felm_background_int_dg_fit_cut1.pdf}
	\fig*[4.5cm]{fig/pdf/felm_background_before.pdf}
	}\hskip3mm\raise12mm\vbox{\hsize10.5cm
...
}\hss\fig*[4cm]{fig/pdf/felm_unfolding_m1_fit_slides.pdf}}
...
}\hss\fig*[4cm]{fig/pdf/felm_unfolding_m1m2_cmp.pdf}}

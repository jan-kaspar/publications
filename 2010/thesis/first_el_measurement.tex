...
\> {\bf Optics tuning}. Various measurable quantities (including the elastic peak titls, see \Tb{al el yx}) have been used to finetune the optics by optimizing the rotations and strengths of the \abb{LHC} magnets within their nominal uncertainties.

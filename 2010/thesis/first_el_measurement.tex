...
where for example $x^{56}_{\rm F}$ is the $x$ component of the hit in the 56-220-far unit and $L^{56}_{x, \rm F}$ is the corresponding effective length. The magnification terms in \Eq{ttm lin par} are small for this optics and have been treated as a perturbation, such as the beam divergence.
...
\>> \TODO{$\th_y$ matching between diagonals for the vertical alignment wrt. the beam.}

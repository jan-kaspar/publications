...
% All detectors are read out with the same front-end chip \abb{VFAT} chips \bref{vfat}.
...
\eqref{
	...
	\ ,\qquad
	{\cal L} = {1+\rh^2\over 16\pi}\, {(N_{\rm el} + N_{\rm inel})^2\over \d N_{\rm el}/\d t|_{t=0} }\ .
}{ttm li meth}

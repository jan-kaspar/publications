...
\Fg{ttm det overview} shows an overview of the detector apparatus of TOTEM. All detectors are placed symmetrically about IP5 (which is shared with the CMS experiment). 

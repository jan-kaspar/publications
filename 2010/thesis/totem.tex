...
The versatile programme of TOTEM requires several running scenarios
...
\fig{fig/pdf/hit_distribution.pdf}{hit distribution}{Simulated distribution of elastic-scattering protons \TODO{what unit} for the three types of optics.}

...
\centerline{\fig[5cm]{fig/dNdeta_zimpact.png}}
...
\centerline{
	\fig[,3.5cm]{fig/dNdeta_8TeV_with_CMS.png}%
	\hskip3mm
	\fig[,3.5cm]{fig/dNdeta_8TeV_with_CMS_SD_enhanced.png}%
}

\> TOTEM only, with displaced vertex ($z = 11.25\un{m}$)

\centerline{
	\fig[,3.5cm]{fig/dNdeta_8TeV_displaced_vertex.png}%
}
...
\centerline{\fig[10cm]{fig/run_2015_90m_trigger.png}}
...
\newpage %-------------------------------------------------------------------------------------------
\ctitle{Outlook for 2016}{Odderon}
